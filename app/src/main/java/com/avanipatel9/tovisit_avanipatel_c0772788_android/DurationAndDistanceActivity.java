...
public class DurationAndDistanceActivity extends AppCompatActivity implements OnMapReadyCallback, Serializable {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMarkerDragListener(new GoogleMap.OnMarkerDragListener() {
            ...
            public void onMarkerDragEnd(Marker marker) {
                Geocoder geocoder = new Geocoder(DurationAndDistanceActivity.this);
                ...
                try {
                    ...
                    if (!addresses.isEmpty()) {
                        ...
                        if  (mDatabase.updatePlace(id,addresses.get(0).getLocality(),marker.getPosition().longitude,addresses.get(0).getAddressLine(0),marker.getPosition().latitude,plcaevisit)){
                            Toast.makeText(DurationAndDistanceActivity.this, "addres;"+marker.getPosition().latitude, Toast.LENGTH_SHORT).show();
                        }
        ...
        locationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                for (Location location : locationResult.getLocations()) {
                    ...
                    mMap.addMarker(new MarkerOptions().position(userLoaction).title("Your Location").icon(bitmapDescriptorFromVector(getApplicationContext(), R.drawable.marker)));
                }
            }
        };
    }
    ...
    public void placeVisited(View view) {
        ...
        if(mDatabase.updateVisit(id,plcaevisit)){
            Toast.makeText(DurationAndDistanceActivity.this, "Place Visited", Toast.LENGTH_SHORT).show();

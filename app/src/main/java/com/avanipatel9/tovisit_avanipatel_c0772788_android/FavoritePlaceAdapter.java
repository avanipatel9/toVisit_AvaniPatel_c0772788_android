...
public class FavoritePlaceAdapter extends ArrayAdapter {
    ...
    public FavoritePlaceAdapter(@NonNull Context mContext, int layoutRes, List<FavouritePlace> favouritePlaces, DatabaseHelper mdatabase) {
